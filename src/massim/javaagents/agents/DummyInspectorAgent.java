...
public class DummyInspectorAgent extends Agent {

	public DummyInspectorAgent(String name, String team) {
		super(name, team);
	...
	private void handlePercepts() {
		...
		for ( Percept p : percepts ) {
                    ...
                    if (p.getName().equals("role")) {
                        println(this.getName() + " with role Inspector is assigned role " + p.getParameters().get(0).toString());
                    } else 
                    */
